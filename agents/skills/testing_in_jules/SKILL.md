---
name: testing_in_jules
description: Core instructions for testing in the Jules VM environment, handling UI tour failures, suppressing fatal teardowns, and fixing linter errors. Use this skill when running the test runner or dealing with test failures in the system.
---
