---
name: debugging_with_antigravity
description: Guide on how to debug Odoo UI Tours and use Antigravity to attach to headless Chrome DevTools via MCP. Use this skill when you need to debug Odoo test suites and UI tours using the pause-on-fail flag.
---
