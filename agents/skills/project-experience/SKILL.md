...
**Condition:** When running UI tours in isolated/sandboxed CI environments, tests may randomly fail due to Odoo 19's asynchronous Owl framework rendering elements slower than the test runner executes steps (e.g., clicking a button inside a modal before it is fully mounted).
