---
name: llm_testing_transactions
description: Critical guidelines on Testing & Transaction Isolation in Odoo, including when to use HamsHttpCase vs RealTransactionCase. Use this skill when writing tests to avoid database pollution and concurrent deadlock exceptions.
---
