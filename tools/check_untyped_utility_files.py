...
EXCLUDED_FILES = {
    "daemons/pdns_sync/test_pdns_sync.py",
    "daemons/aprs_is_sync/main.py",
    "daemons/ham_dx_daemon/main.py",
    "daemons/hams_local_relay/main.py",
    "daemons/noaa_swpc_sync/main.py",
    "daemons/noaa_swpc_sync/test_noaa_swpc_sync.py",
    "daemons/hams_local_relay/tools/rig_simulator.py",
    "daemons/hams_simulated_bots/main.py",
    "daemons/hams_simulated_bots/tests/test_main.py",
