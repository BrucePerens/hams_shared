...
It also includes a **Noisy Table Management** interface ([@ANCHOR: COMM_UX_NOISY_TABLE_MANAGEMENT]) to allow administrators to whitelist tables from leak detection.
